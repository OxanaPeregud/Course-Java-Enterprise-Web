...
<html>
<head>
    <title>Calculate Rectangle Perimeter</title>
</head>
<body>

<form name="calculate" action="${pageContext.request.contextPath}/calculate-rectangle-perimeter" method="POST">

    <div>
        <h3>Calculating Rectangle Perimeter</h3>
    </div>
